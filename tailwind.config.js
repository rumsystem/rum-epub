  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        '4b': '0px 2px 4px -1px rgba(0,0,0,.3),0px 4px 5px 0px rgba(0,0,0,.21),0px 1px 10px 0px rgba(0,0,0,.18)',
        ...
        '10': '0px 6px 6px -3px rgba(255,255,255,.2),0px 10px 14px 1px rgba(255,255,255,.14),0px 4px 18px 3px rgba(255,255,255,.12)',
      },
      transitionDuration: {
        '0': '0ms',
      },
