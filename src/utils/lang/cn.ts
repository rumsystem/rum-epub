...
export const content = {
  ...
  group: {
    ...
    linkGroup: '链接评论种子网络',
    unLinkGroup: '取消链接评论种子网络',
  },
  linkGroup: {
    linked: '已链接种子网络',
    linkGroup: '链接评论种子网络',
    selectFromExistedSeednet: '从已有种子网络选一个',
    seednetSelectPlaceholder: '选择一个种子网络',
    noSeednet: '暂无种子网络',
    createSeednet: '创建种子网络',
    joinSeednet: '加入种子网络',
    link: '链接',
    noChapter: '不记录章节',
    postInputPlaceholder: '有什么想法',
    publish: '发布',
    replyPlaceHolder: '说些什么',
    ...
    unlinked: '已取消链接',
    notLinkedSeednet: '未链接的评论种子网络',
    like: '赞',
    comment: '评论',
    noCommentSeednetLinked: '当前种子网络还没有链接评论种子网络',
    goLink: '去链接',
    openInDetail: '打开详情',
    postNotFound: '找不到内容',
    latest: '最新',
  ...
  epubMetadata: {
    ...
    autherTip: '多个人名间请使用 & 分隔。国籍用小括号，如 (法)。外国人名使用 ･ 分隔',
    authorInsertSeperator: '插入･',
  ...
  createGroup: {
    ...
    linkGroupTemplateTip: '创建一个关联种子网络发布评论内容',
    NA: '未开放',
    book: '书籍',
    linkGroup: '书籍评论',
    ...
    confirmCreateEpubLinkSeednet: '确定新建种子网络：书籍 Epub Link',
    confirmCreateTip: '种子网络建立后，将无法修改种子网络的名称，默认权限设置，以及种子网络的模板。',
    backAndEdit: '返回修改',
    confirmCreateAndUpload: '确认创建，上传文件',
    confirmCreate: '确认创建',
    created: '创建成功',
  },
  joinGroup: {
